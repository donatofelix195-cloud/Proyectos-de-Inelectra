...
(defun EX_AnexoTipos (xs cr counts forma mat / col_idx d_val total t_lr t_ll t_lb dec_dia rt tc tipo_pair)
    ...
    (foreach tipo_pair (list (cons "LR" t_lr) (cons "LL" t_ll) (cons "LB" t_lb))
      (if (> (cdr tipo_pair) 0)
        (progn
          ...
          (vlax-put-property (vlax-get-property xs 'Range (strcat (EX_GEX col_idx) (itoa (+ cr 3)))) 'Value2 (EX_BuscarTapaCode dec_dia forma mat))
          (vlax-put-property (vlax-get-property xs 'Range (strcat (EX_GEX col_idx) (itoa (+ cr 4)))) 'Value2 (EX_BuscarEmpaCode dec_dia forma mat))
  ...
  (vlax-put-property tc 'MergeCells :vlax-true) (vlax-put-property tc 'Value2 "--- ANEXO: TIPO CONDULETAS ---") (vlax-put-property (vlax-get-property tc 'Font) 'Bold :vlax-true) (vlax-put-property (vlax-get-property tc 'Interior) 'Color 13421823)
)
...
(defun EX_AnexoCondC (xs cr counts forma mat / col_idx d_val sum_in pz dec_dia rt tc)
  ...
  (foreach item counts
    ...
    (vlax-put-property (vlax-get-property xs 'Range (strcat (EX_GEX col_idx) (itoa (+ cr 4)))) 'Value2 (EX_BuscarTapaCode dec_dia forma mat))
    (vlax-put-property (vlax-get-property xs 'Range (strcat (EX_GEX col_idx) (itoa (+ cr 5)))) 'Value2 (EX_BuscarEmpaCode dec_dia forma mat))
    (setq col_idx (1+ col_idx))
  )
  (setq tc (vlax-get-property xs 'Range (strcat "E" (itoa (1- cr)) ":" (EX_GEX (1- col_idx)) (itoa (1- cr)))))
  (vlax-put-property tc 'MergeCells :vlax-true) (vlax-put-property tc 'Value2 "--- ANEXO: CONDULETA TIPO C Y UNION ---") (vlax-put-property (vlax-get-property tc 'Font) 'Bold :vlax-true) (vlax-put-property (vlax-get-property tc 'Interior) 'Color 13421823)
)

(defun EX_AnexoTEEDetalle (xs cr counts forma mat / col_idx d_val d_cnt dec_dia rt tc)
  (setq col_idx 6 cr (1+ cr))
  (setq rt (vlax-get-property xs 'Range (strcat "E" (itoa cr) ":E" (itoa (+ cr 4)))))
  (vlax-put-property (vlax-get-property rt 'Interior) 'Color 13421823) (vlax-put-property (vlax-get-property rt 'Font) 'Bold :vlax-true)
  (vlax-put-property (vlax-get-property xs 'Range (strcat "E" (itoa cr))) 'Value2 "DIAMETRO")
  ...
  (setq tc (vlax-get-property xs 'Range (strcat "E" (itoa (1- cr)) ":" (EX_GEX (1- col_idx)) (itoa (1- cr)))))
  (vlax-put-property tc 'MergeCells :vlax-true) (vlax-put-property tc 'Value2 "--- ANEXO: TIPO CONDULETAS TIPO T ---") (vlax-put-property (vlax-get-property tc 'Font) 'Bold :vlax-true) (vlax-put-property (vlax-get-property tc 'Interior) 'Color 13421823)
)
...
(defun EX_AnexoExpansion (xs cr counts forma mat / col_idx d_val sum_in pz dec_dia rt tc)
  ...
  (setq tc (vlax-get-property xs 'Range (strcat "E" (itoa (1- cr)) ":" (EX_GEX (1- col_idx)) (itoa (1- cr)))))
  (vlax-put-property tc 'MergeCells :vlax-true) (vlax-put-property tc 'Value2 "--- ANEXO: JUNTAS DE EXPANCION ---") (vlax-put-property (vlax-get-property tc 'Font) 'Bold :vlax-true) (vlax-put-property (vlax-get-property tc 'Interior) 'Color 13421823)
)
...
(defun EX_AnexoTuberiaRigida (xs cr counts mat / col_idx d_val sum_in pz dec_dia rt tc)
  ...
  (setq tc (vlax-get-property xs 'Range (strcat "E" (itoa (1- cr)) ":" (EX_GEX (1- col_idx)) (itoa (1- cr)))))
  (vlax-put-property tc 'MergeCells :vlax-true) (vlax-put-property tc 'Value2 "--- ANEXO: TUBERIA RIGIDA ---") (vlax-put-property (vlax-get-property tc 'Font) 'Bold :vlax-true) (vlax-put-property (vlax-get-property tc 'Interior) 'Color 13421823)
)
        ...
        (progn (setq sb '()) (foreach x bl (if (= (cdr x) 1) (setq sb (cons (car x) sb))))
          (if sb 
            (progn (setq mi 53 t_s '("BLOQUE") ty '() i 0 hm nil ft 0.0 fc 0.0 pipe_sums '() tee_detailed_counts '())
              ...
              (if hm (setq cr (EX_AnexoPipe xs cr (strcat (EX_GEX mi) "2:" (EX_GEX mi) (itoa (1- r))) mi)))
              (setq cr (+ cr 2))
              (if cond_counts (progn (EX_AnexoTipos xs cr cond_counts *forma_sel* *mat_sel*) (setq cr (+ cr 7))))
              (if tee_detailed_counts (progn (EX_AnexoTEEDetalle xs cr tee_detailed_counts *forma_sel* *mat_sel*) (setq cr (+ cr 7))))
              (if pipe_sums (progn (EX_AnexoTuberiaRigida xs cr pipe_sums *mat_sel*) (setq cr (+ cr 6)) (EX_AnexoCondC xs cr pipe_sums *forma_sel* *mat_sel*) (setq cr (+ cr 8)) (EX_AnexoExpansion xs cr pipe_sums *forma_sel* *mat_sel*)))
